<script context="module">
  ...
  export async function preload(page, session) {
    ...
    console.log("VIEW PRELOAD SESSION:" + JSON.stringify(session.user));
    ...
    try {
      ...
      session.userstats = userstats.data;
      console.log("GETUSERSTATS PRELOAD:" + JSON.stringify(userstats));
  ...
  <form class="charsheet">
    <header>
      <section class="charname">
        ...
        <input
          name="charname"
          placeholder="{$session.user.firstName ? $session.user.firstName : ''}
