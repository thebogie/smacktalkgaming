...
LOGGED IN, ADD BIG PICTURE STUFF
      ...
      <div class="row">
        ...
        <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
          <div class="left-heading">
            <h5>Smack talking is fun.</h5>
          </div>
          <div class="left-text">
            <p>
              Has your group of board gaming friends ever said: If only we had a
              source of truth to keep all of our groups game statisitics. So
              that I can prove that won 30 games of Splendor and I can hold
              those numbers over everybody... if only.
            </p>
    ...
    <div class="container">
      <div class="row">
        <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
          ...
          <p>Put in those stats and watch the smacktalk fly!</p>
          <ul>
            <li>
              <img src="assets/images/about-icon-01.png" alt="" />
              <div class="text">
                <h6>Glicko2 ratings!</h6>
                <p>
                  See your rating compared to everybody in your gaming circle.
                </p>
              </div>
            </li>
            <li>
              ...
              <div class="text">
                <h6>User Stats</h6>
                <p>
                  How many times you played one game? How many times you beat
                  Curley? How many times you lost on a Saturday
                </p>
              </div>
            </li>
            <li>
              ...
              <div class="text">
                <h6>Send smacktalk messages across the internet</h6>
                <p>
                  facebook stats, instagram pictures, myspace, linkedin! Send
                  smack all around the world in instant.
                </p>
              </div>
            </li>
          </ul>
              ...
              <div class="accordion-body">
                <div class="content">
                  <p>
                    ...
                    sapien. Sed cursus lacus quis arcu scelerisque, eget ornare
                    risus maximus. Aenean non lectus id odio rhoncus pharetra.
                  </p>
                </div>
              </div>
            </article>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          <div id="map">
            <!-- How to change your own map point
                    ...
                    -->
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d220449.36395566893!2d-97.89348302580635!3d30.307686294497085!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8644b599a0cc032f%3A0x5d9b464bd469d57a!2sAustin%2C%20TX!5e0!3m2!1sen!2sus!4v1594419029290!5m2!1sen!2sus"
              width="600"
              height="450"
              frameborder="0"
              style="border:0;"
