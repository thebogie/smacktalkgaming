<script>
  ...
  console.log("ISUSER:" + JSON.stringify(user) + JSON.stringify(profile))

  $: isUser = user 
  //TODO check that user is the same? && profile.username === user.username;
...
<form class="charsheet">
  <header>
    ...
    <section class="misc">
      <ul>
        <li>
          <label for="classlevel">Contests Played</label>
          <input name="classlevel" value={profile.Contestsplayed} />
        </li>
        <li>
          <label for="background">Games Played</label>
          <input name="background" value={profile.Gamesplayed} />
        </li>
        <li>
          <label for="playername">Competitors</label>
          <input name="playername" value={profile.Competitors} />
        </li>
        <li>
          <label for="race">Contests Won</label>
          <input name="race" value={profile.Contestswon} />
        </li>
        <li>
          <label for="alignment">Contests Tied</label>
          <input name="alignment" value={profile.Conteststied} />
        </li>
        <li>
          <label for="experiencepoints">Contests Lost</label>
          <input
            name="experiencepoints"
            value={profile.Conteststied} />
        </li>
      </ul>
    </section>
  </header>
      ...
      <section class="attributes">
        <div class="scores">
          <ul>
            <li>
              <div class="score">
                <label for="Strengthscore">Games Won</label>
                <input name="Strengthscore" placeholder="10" class="stat" />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Dexterityscore">Games Lost</label>
                <input name="Dexterityscore" placeholder="10" class="stat" />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                ...
                <input name="Constitutionscore" placeholder="10" class="stat" />
              </div>
              <div class="modifier">
                <input
            ...
            <li>
              <div class="score">
                ...
                <input name="Intelligencescore" placeholder="10" class="stat" />
              </div>
              <div class="modifier">
                <input
            ...
            <li>
              <div class="score">
                ...
                <input name="Charismascore" placeholder="10" class="stat" />
              </div>
              <div class="modifier">
    ...
    <section>
      <section class="combat">
        <div class="armorclass">
          <div>
            <label for="ac">Games Won</label>
            <input name="ac" placeholder="10" type="text" />
          </div>
        </div>
        <div class="initiative">
          <div>
            <label for="initiative">Games Lost</label>
            <input name="initiative" placeholder="+0" type="text" />
          </div>
        </div>
        <div class="speed">
          <div>
            <label for="speed">Games Tied</label>
